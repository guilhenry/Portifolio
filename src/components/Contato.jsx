function Contato() {
    return (
        <>
            <div id="contato" className=" flex   flex-col  items-center bg-[#1C2830] h-[300px]">
                <h1>Fale comigo !</h1>
                <div className=" ">
                    <h4><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4 4H20C21.1 4 22 4.9 22 6V18C22 19.1 21.1 20 20 20H4C2.9 20 2 19.1 2 18V6C2 4.9 2.9 4 4 4Z" stroke="#30cc00ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M22 6L12 13L2 6" stroke="#30cc00ff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg> Email: guilhermihenry@gmail.com</h4>
                    <h4><img src="../src/assets/celular.svg" alt="" />+55 31988136258</h4>
                    <a className="m-[20px]  h-[40px] w-[140px] bg-[#1C2830] text-[#30cc00ff] flex items-center justify-center pointer border-2 border-[#30cc00ff] hover:bg-[#30cc00ff] hover:text-white" href="https://api.whatsapp.com/send?phone=5531988136258&text=Fala,%20Guilherme!%20Vim%20do%20teu%20portif%C3%B3lio,%20quero%20trabalhar%20contigo"><svg width="24" height="24" color="#09eb27" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
